...
namespace Osu.Utils
{
    ...
    public abstract class JsonReader : IDisposable
    {
        ...
        private void Push(JsonContainerType value)
        {
            ...
            else
            {
                ...
                if (_maxDepth != null && Depth + 1 > _maxDepth && !_hasExceededMaxDepth)
                {
                    ...
                    throw JsonReaderException.Create(this, string.Format("The reader's MaxDepth of {0} has been exceeded.", _maxDepth));
                }
            }
        }
        ...
        public virtual int? ReadAsInt32()
        {
            ...
            throw JsonReaderException.Create(this, string.Format("Error reading integer. Unexpected token: {0}.", t));
        }
        ...
        internal int? ReadInt32String(string s)
        {
            ...
            else
            {
                ...
                throw JsonReaderException.Create(this, string.Format("Could not convert string to integer: {0}.", s));
            }
        }
        ...
        public virtual string ReadAsString()
        {
            ...
            throw JsonReaderException.Create(this, string.Format("Error reading string. Unexpected token: {0}.", t));
        }
        ...
        public virtual byte[] ReadAsBytes()
        {
            ...
            throw JsonReaderException.Create(this, string.Format("Error reading bytes. Unexpected token: {0}.", t));
        }
            ...
            while (true)
            {
                ...
                switch (t)
                {
                    ...
                    case JsonToken.EndArray:
                        ...
                        return d;
                    default:
                        throw JsonReaderException.Create(this, string.Format("Unexpected token when reading bytes: {0}.", t));
                }
            }
        }
        ...
        public virtual double? ReadAsDouble()
        {
            ...
            throw JsonReaderException.Create(this, string.Format("Error reading double. Unexpected token: {0}.", t));
        }
        ...
        internal double? ReadDoubleString(string s)
        {
            ...
            {
                SetToken(JsonToken.String, s, false);
                throw JsonReaderException.Create(this, string.Format("Could not convert string to double: {0}.", s));
            }
        }
        ...
        public virtual bool? ReadAsBoolean()
        {
            ...
            throw JsonReaderException.Create(this, string.Format("Error reading boolean. Unexpected token: {0}.", t));
        }
        ...
        internal bool? ReadBooleanString(string s)
        {
            ...
            {
                SetToken(JsonToken.String, s, false);
                throw JsonReaderException.Create(this, string.Format("Could not convert string to boolean: {0}.", s));
            }
        }
        ...
        public virtual decimal? ReadAsDecimal()
        {
            ...
            throw JsonReaderException.Create(this, string.Format("Error reading decimal. Unexpected token: {0}.", t));
        }
        ...
        internal decimal? ReadDecimalString(string s)
        {
            ...
            {
                SetToken(JsonToken.String, s, false);
                throw JsonReaderException.Create(this, string.Format("Could not convert string to decimal: {0}.", s));
            }
        }
        ...
        public virtual DateTime? ReadAsDateTime()
        {
            ...
            throw JsonReaderException.Create(this, string.Format("Error reading date. Unexpected token: {0}.", TokenType));
        }
        ...
        internal DateTime? ReadDateTimeString(string s)
        {
            ...
            throw JsonReaderException.Create(this, string.Format("Could not convert string to DateTime: {0}.", s));
        }
        ...
        public virtual DateTimeOffset? ReadAsDateTimeOffset()
        {
            ...
            switch (t)
            {
                ...
                default:
                    throw JsonReaderException.Create(this, string.Format("Error reading date. Unexpected token: {0}.", t));
            }
        }
        ...
        internal DateTimeOffset? ReadDateTimeOffsetString(string s)
        {
            ...
            SetToken(JsonToken.String, s, false);
            throw JsonReaderException.Create(this, string.Format("Could not convert string to DateTimeOffset: {0}.", s));
        }
#endif
        ...
        protected void SetStateBasedOnCurrent()
        {
            ...
            switch (currentObject)
            {
                ...
                case JsonContainerType.None:
                    ...
                    break;
                default:
                    throw JsonReaderException.Create(this, string.Format("While setting the reader state back to current object an unexpected JsonType was encountered: {0}", currentObject));
            }
        }
        ...
        private JsonContainerType GetTypeForCloseToken(JsonToken token)
        {
            switch (token)
            {
                ...
                default:
                    throw JsonReaderException.Create(this, string.Format("Not a valid close JsonToken: {0}", token));
            }
        }
